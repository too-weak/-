...
template <class T>
void BinaryTree<T>::non_rPreOrder(BinaryTreeNode<T> *root) {
    cout<<"非递归前序："<<"   ";
    if (root == NULL)
        return;
...
template <class T>
void BinaryTree<T>::non_rInOrder(BinaryTreeNode<T> *root) {
    cout<<"非递归中序："<<"   ";
    stack<BinaryTreeNode<T>*> sta;
    BinaryTreeNode<T> *p = root;
    while(!sta.empty() || p){
...
template <class T>
void BinaryTree<T>::non_rPostOrder(BinaryTreeNode<T> *root) {
    cout<<"非递归后序："<<"   ";
    stack<BinaryTreeNode<T> *> sta;
    BinaryTreeNode<T> *pointer = root;
    BinaryTreeNode<T> *pre = root;
    while(pointer){
        for(; pointer->leftChild; pointer = pointer->leftChild)
            sta.push(pointer);
        while(pointer &&
